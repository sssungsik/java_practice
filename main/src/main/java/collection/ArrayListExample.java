...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		// ArrayList 컬렉션 생성
		List<Mcdonals> list = new ArrayList<>();
		
		// 객체 추가
		list.add(new Mcdonals("Bulgoki Burger", "Hamburger", 5000));
		list.add(new Mcdonals("Soda", "Beverage", 2000));
		list.add(new Mcdonals("Shrimp Burger", "Hamburger",5000));
		list.add(new Mcdonals("French Fries", "Disert", 1500));
